...
public class Example extends AutonomousBase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        setupAndWait();
        robotDriver.gyroDrive(0.6d, -20d, 0d, 5d, null);
        //release to bucket+
        sleep(1000);
        ...
        sleep(500);
        robotDriver.gyroDrive(1.0d, 10d, 0d, 5d, null);
        robotDriver.gyroDrive(1.0d, -12d, 0d, 5d, null);
        robotDriver.gyroDrive(1.0d,10d, 0d, 5d, null);
        robotDriver.gyroDrive(1.0d,-13d, 0d, 5d, null);
        sleep(500);
